            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>클라우드 모범 사례</h3>
                            <p>자동 크기 조정, 캐싱, 데이터 분할, API 디자인 등과 같은 측면을 다루는 클라우드 애플리케이션에 대한 모범 사례입니다.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>아키텍처 센터에 대한 아이디어 제출</h3>
                            <p>새 아키텍처 또는 디자인 설명서에 대한 아이디어가 있으십니까?</p>
                            <p>Azure 아키텍처 센터에서 어떤 종류의 문서를 사용하시겠습니까?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure에서 성능 및 확장성을 위한 디자인</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure에서 가용성 및 복구 가능성을 위한 디자인</h3>
                    </div>
                </div>
            </div>
        </div>
