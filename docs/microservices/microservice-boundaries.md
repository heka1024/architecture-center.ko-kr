...
**응용 프로그램 통합**. 서버리스 아키텍처를 사용하면 복잡한 애플리케이션을 개발하기 어려울 수 있습니다. Azure의 한 가지 옵션은 [Azure Logic Apps](/azure/logic-apps/)를 사용하여 Azure Functions 집합을 조정하는 것입니다. 이러한 방법에 대한 예제는 [Azure Logic Apps와 통합하는 함수 만들기](/azure/azure-functions/functions-twitter-email)를 참조하세요.
