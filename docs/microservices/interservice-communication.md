...
![서비스 간 통신의 다이어그램](./images/interservice-communication.png)
...
이러한 사항을 고려하여, 개발 팀은 드론 배달 애플리케이션 설계를 위해 다음과 같은 선택을 했습니다.

- 수집 서비스는 클라이언트 애플리케이션에서 배달을 예약, 업데이트 또는 취소하는 데 사용되는 공용 REST API를 노출합니다.
...
![드론 통신의 다이어그램](./images/drone-communication.png)
...
> [!NOTE]
> 서비스 메시는 [특사 패턴](../patterns/ambassador.md)의 예입니다. &mdash; 이것은 애플리케이션 대신 네트워크 요청을 보내는 도우미 서비스입니다.
