...
| --- | --- | --- | --- | --- | --- |
| 관리되는 서비스인지 여부 | yes | yes | 예 <sup>1</sup> | yes | 
| 관계형 데이터 저장소 | yes | yes | 아니요 | 아니요 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 자동 확장 | 아니요 | 아니요 | 아니요 | 아니요 | 아니요 | yes |
| 스케일 아웃 단위  | 작업 기준 | 클러스터 기준 | 클러스터 기준 | 클러스터 기준 | 클러스터 기준 | 클러스터 기준 |
| 데이터의 메모리 내 캐싱 | 아니요 | 예 | yes | 아니요 | 예 | yes |
| 외부 관계형 저장소에서 쿼리 | yes | 아니요 | yes | 아니요 | 아니요 | yes |
| 인증  | Azure AD | SQL / Azure AD | 아니요 | Azure AD<sup>1</sup> | Azure AD<sup>1</sup> | Azure AD |
| 감사  | yes | yes | 아니요 | 예 <sup>1</sup> | 예 <sup>1</sup> | yes |
| 행 수준 보안 | 아니요 | 아니요 | 아니요 | 예 <sup>1</sup> | 예 <sup>1</sup> | 아니요 |
| 방화벽 지원 여부 | yes | 예 | yes | 예 <sup>2</sup> | 예 <sup>2</sup> | 아니요 |
