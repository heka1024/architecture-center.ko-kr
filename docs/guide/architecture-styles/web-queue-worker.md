...
- 프런트 엔드는 Azure App Service 웹 앱으로 구현 하 고 작업자 Azure 함수 앱으로 구현 됩니다. 웹 앱 및 함수 앱은 모두 VM 인스턴스를 제공 하는 App Service 계획을 사용 하 여 연결 합니다.
...
- 별도 App Service 계획에서 웹 앱 및 함수 앱을 넣는 것이 좋습니다. 이런 방식으로 확장할 수 있습니다 하지 독립적으로 합니다.
