...
**응용 프로그램이 클라우드 리소스를 효율적으로 사용하고 있는지 확인합니다.** 각 VM에서 실행 중인 응용 프로그램 코드를 이용하여 각 응용 프로그램에서 리소스를 최대한 효율적으로 사용하고 있는지 확인합니다. [Application Insights][application-insights]와 같은 도구를 사용할 수 있습니다.
