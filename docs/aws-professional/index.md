...
- [Service Fabric](https://docs.microsoft.com/en-us/azure/service-fabric/service-fabric-overview)은 확장 가능한 [마이크로서비스](/azure/service-fabric/service-fabric-overview-microservices) 솔루션을 개발하고 호스팅할 수 있는 플랫폼입니다.
