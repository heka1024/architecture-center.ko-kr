...
Dave는 구독을 만든 후 적절한 팀 및 애플리케이션 소유자가 자신의 리소스에 액세스할 수 있는지 확인하려고 합니다. Dave는 팀마다 요구 사항이 서로 다르다는 것을 알게 됩니다. 그는 Contoso의 온-프레미스 AD(Active Directory)에서 Azure Active Directory로 동기화된 그룹을 활용하고 팀에 적합한 액세스 수준을 제공합니다.
