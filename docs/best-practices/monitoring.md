...
* [상태 엔드포인트 모니터링 패턴](https://msdn.microsoft.com/library/dn589789.aspx) 에서는 외부 도구가 노출된 엔드포인트를 통해 정기적인 간격으로 액세스할 수 있는 기능 검사를 응용 프로그램 내부에 구현하는 방법을 설명합니다.
