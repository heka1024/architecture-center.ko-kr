...
* <span data-ttu-id="4c0b1-112">고객에게 인터넷 연결 AD FS 팜이 있어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-112">The customer must have an Internet-facing AD FS farm.</span></span>
...
<span data-ttu-id="4c0b1-126">ASP.NET 4에서 WS-Federation을 사용하는 예제는 [active-directory-dotnet-webapp-wsfederation 샘플][active-directory-dotnet-webapp-wsfederation]을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-126">For an example of using WS-Federation with ASP.NET 4, see the [active-directory-dotnet-webapp-wsfederation sample][active-directory-dotnet-webapp-wsfederation].</span></span>
...
| <span data-ttu-id="4c0b1-158">이름</span><span class="sxs-lookup"><span data-stu-id="4c0b1-158">name</span></span> |<span data-ttu-id="4c0b1-159">사용자 이름.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-159">User name.</span></span> <span data-ttu-id="4c0b1-160">예제: `john@corp.fabrikam.com`</span><span class="sxs-lookup"><span data-stu-id="4c0b1-160">Example: `john@corp.fabrikam.com`</span></span> |
...
## <a name="configure-openid-connect-authentication-with-ad-fs"></a><span data-ttu-id="4c0b1-186">AD FS를 사용하여 OpenID Connect 인증 구성</span><span class="sxs-lookup"><span data-stu-id="4c0b1-186">Configure OpenID Connect authentication with AD FS</span></span>
...
4. <span data-ttu-id="4c0b1-205">"온라인으로 게시된 또는 로컬 네트워크에서 클레임 공급자에 대한 데이터 가져오기" 옵션을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-205">Select the option "Import data about the claims provider published online or on a local network".</span></span> <span data-ttu-id="4c0b1-206">고객의 페더레이션 메타데이터 엔드포인트 URI를 입력합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-206">Enter the URI of the customer's federation metadata endpoint.</span></span> <span data-ttu-id="4c0b1-207">(예: `https://contoso.com/FederationMetadata/2007-06/FederationMetadata.xml`) 이 정보는 고객으로부터 받아야 합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-207">(Example: `https://contoso.com/FederationMetadata/2007-06/FederationMetadata.xml`.) You will need to get this from the customer.</span></span>
5. <span data-ttu-id="4c0b1-208">기본 옵션을 사용하여 마법사를 완료합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-208">Complete the wizard using the default options.</span></span>

### <a name="edit-claims-rules"></a><span data-ttu-id="4c0b1-209">클레임 규칙 편집</span><span class="sxs-lookup"><span data-stu-id="4c0b1-209">Edit claims rules</span></span>
1. <span data-ttu-id="4c0b1-210">새로 추가된 클레임 공급자 트러스트를 마우스 오른쪽 단추로 클릭하고 **클레임 규칙 편집**을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-210">Right-click the newly added claims provider trust, and select **Edit Claims Rules**.</span></span>
2. <span data-ttu-id="4c0b1-211">**규칙 추가**를 클릭합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-211">Click **Add Rule**.</span></span>
3. <span data-ttu-id="4c0b1-212">"들어오는 클레임 통과 또는 필터링"을 선택하고 **다음**을 클릭합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-212">Select "Pass Through or Filter an Incoming Claim" and click **Next**.</span></span>
   <span data-ttu-id="4c0b1-213">![변환 클레임 규칙 추가 마법사](./images/edit-claims-rule.png)</span><span class="sxs-lookup"><span data-stu-id="4c0b1-213">![Add Transform Claim Rule Wizard](./images/edit-claims-rule.png)</span></span>
4. <span data-ttu-id="4c0b1-214">규칙의 이름을 입력합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-214">Enter a name for the rule.</span></span>
5. <span data-ttu-id="4c0b1-215">"들어오는 클레임 유형"에서 **UPN**을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-215">Under "Incoming claim type", select **UPN**.</span></span>
6. <span data-ttu-id="4c0b1-216">"모든 클레임 값 통과"를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-216">Select "Pass through all claim values".</span></span>
   <span data-ttu-id="4c0b1-217">![변환 클레임 규칙 추가 마법사](./images/edit-claims-rule2.png)</span><span class="sxs-lookup"><span data-stu-id="4c0b1-217">![Add Transform Claim Rule Wizard](./images/edit-claims-rule2.png)</span></span>
7. <span data-ttu-id="4c0b1-218">**Finish**를 클릭합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-218">Click **Finish**.</span></span>
8. <span data-ttu-id="4c0b1-219">2 - 7단계를 반복하고 들어오는 클레임 유형에 대해 **앵커 클레임 유형** 을 지정합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-219">Repeat steps 2 - 7, and specify **Anchor Claim Type** for the incoming claim type.</span></span>
9. <span data-ttu-id="4c0b1-220">**확인** 을 클릭하여 마법사를 완료합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-220">Click **OK** to complete the wizard.</span></span>

### <a name="enable-home-realm-discovery"></a><span data-ttu-id="4c0b1-221">홈 영역 검색을 사용하도록 설정</span><span class="sxs-lookup"><span data-stu-id="4c0b1-221">Enable home-realm discovery</span></span>
<span data-ttu-id="4c0b1-222">다음 PowerShell 스크립트를 실행합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-222">Run the following PowerShell script:</span></span>

```
Set-ADFSClaimsProviderTrust -TargetName "name" -OrganizationalAccountSuffix @("suffix")
```

<span data-ttu-id="4c0b1-223">여기서 "name"은 클레임 공급자 트러스트의 친숙한 이름이고 "suffix"는 고객의 AD에 대한 UPN 접미사입니다(예: "corp.fabrikam.com").</span><span class="sxs-lookup"><span data-stu-id="4c0b1-223">where "name" is the friendly name of the claims provider trust, and "suffix" is the UPN suffix for the customer's AD (example, "corp.fabrikam.com").</span></span>
...
4. <span data-ttu-id="4c0b1-235">**데이터 원본 선택** 페이지에서 "온라인으로 게시된 또는 로컬 네트워크에서 클레임 공급자에 대한 데이터 가져오기" 옵션을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-235">On the **Select Data Source** page, select the option "Import data about the claims provider published online or on a local network".</span></span> <span data-ttu-id="4c0b1-236">SaaS 공급자의 페더레이션 메타데이터 엔드포인트의 URI를 입력합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-236">Enter the URI of the SaaS provider's federation metadata endpoint.</span></span>
   <span data-ttu-id="4c0b1-237">![신뢰 당사자 트러스트 추가 마법사](./images/add-rp-trust.png)</span><span class="sxs-lookup"><span data-stu-id="4c0b1-237">![Add Relying Party Trust Wizard](./images/add-rp-trust.png)</span></span>
...
6. <span data-ttu-id="4c0b1-239">**Access Control 정책 선택** 페이지에서 정책을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-239">On the **Choose Access Control Policy** page, choose a policy.</span></span> <span data-ttu-id="4c0b1-240">조직에 있는 모든 사람을 허용하거나 특정 보안 그룹을 선택할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-240">You could permit everyone in the organization, or choose a specific security group.</span></span>
   <span data-ttu-id="4c0b1-241">![신뢰 당사자 트러스트 추가 마법사](./images/add-rp-trust2.png)</span><span class="sxs-lookup"><span data-stu-id="4c0b1-241">![Add Relying Party Trust Wizard](./images/add-rp-trust2.png)</span></span>
7. <span data-ttu-id="4c0b1-242">**정책** 상자에 필요한 매개 변수를 입력합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-242">Enter any parameters required in the **Policy** box.</span></span>
8. <span data-ttu-id="4c0b1-243">**다음** 을 클릭하여 마법사를 완료합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-243">Click **Next** to complete the wizard.</span></span>

### <a name="add-claims-rules"></a><span data-ttu-id="4c0b1-244">클레임 규칙 추가</span><span class="sxs-lookup"><span data-stu-id="4c0b1-244">Add claims rules</span></span>
1. <span data-ttu-id="4c0b1-245">새로 추가된 신뢰 당사자 트러스트를 마우스 오른쪽 단추로 클릭하고 **클레임 발급 정책 편집**을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-245">Right-click the newly added relying party trust, and select **Edit Claim Issuance Policy**.</span></span>
2. <span data-ttu-id="4c0b1-246">**규칙 추가**를 클릭합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-246">Click **Add Rule**.</span></span>
3. <span data-ttu-id="4c0b1-247">"LDAP 특성을 클레임으로 전송"을 선택하고 **다음**을 클릭합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-247">Select "Send LDAP Attributes as Claims" and click **Next**.</span></span>
4. <span data-ttu-id="4c0b1-248">규칙의 이름을 입력합니다(예: "UPN").</span><span class="sxs-lookup"><span data-stu-id="4c0b1-248">Enter a name for the rule, such as "UPN".</span></span>
5. <span data-ttu-id="4c0b1-249">**특성 저장소** 아래에서 **Active Directory**를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-249">Under **Attribute store**, select **Active Directory**.</span></span>
   <span data-ttu-id="4c0b1-250">![변환 클레임 규칙 추가 마법사](./images/add-claims-rules.png)</span><span class="sxs-lookup"><span data-stu-id="4c0b1-250">![Add Transform Claim Rule Wizard](./images/add-claims-rules.png)</span></span>
6. <span data-ttu-id="4c0b1-251">**LDAP 특성의 매핑** 섹션에서:</span><span class="sxs-lookup"><span data-stu-id="4c0b1-251">In the **Mapping of LDAP attributes** section:</span></span>
   ...
   * <span data-ttu-id="4c0b1-253">**나가는 클레임 유형** 아래에서 **UPN**을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-253">Under **Outgoing Claim Type**, select **UPN**.</span></span>
     <span data-ttu-id="4c0b1-254">![변환 클레임 규칙 추가 마법사](./images/add-claims-rules2.png)</span><span class="sxs-lookup"><span data-stu-id="4c0b1-254">![Add Transform Claim Rule Wizard](./images/add-claims-rules2.png)</span></span>
...
11. <span data-ttu-id="4c0b1-259">**사용자 지정 규칙**아래에서 다음을 입력합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-259">Under **Custom rule**, enter the following:</span></span>
    ...
    <span data-ttu-id="4c0b1-260">이 규칙은 `anchorclaimtype` 유형의 클레임을 발급합니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-260">This rule issues a claim of type `anchorclaimtype`.</span></span> <span data-ttu-id="4c0b1-261">이 클레임은 신뢰 당사자에게 UPN을 변경할 수 없는 사용자 ID로 사용하도록 알립니다.</span><span class="sxs-lookup"><span data-stu-id="4c0b1-261">The claim tells the relying party to use UPN as the user's immutable ID.</span></span>
