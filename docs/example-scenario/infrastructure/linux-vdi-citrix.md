...
- [Azure 가용성 집합](/azure/virtual-machines/windows/tutorial-availability-sets) Azure에 배포한 Vm 클러스터에서 여러 격리 된 하드웨어 노드에 분산 되는 확인 됩니다. 이렇게 하면 Azure 내의 하드웨어 또는 소프트웨어 오류가 발생할 때 VM의 하위 세트에만 영향을 주며 전체 솔루션을 사용 가능한 운영 상태로 유지할 수 있습니다.
