        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure에서 뉴스 피드 대량 수집 및 분석</h3>
                        <p>Azure Cosmos DB 및 Azure Cognitive Services를 포함한 Azure 서비스만을 사용하여 RSS 뉴스 피드에서 텍스트, 이미지, 감정 및 다른 데이터를 수집하고 분석하는 파이프라인을 만듭니다.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Jenkins, Azure Container Registry, Azure Kubernetes Service, Cosmos DB 및 Grafana를 사용하여 Node.js 웹앱에 대한 DevOps 파이프라인을 빌드합니다.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure에서 Jenkins 서버 실행</h3>
                        <p>SSO(Single Sign-On)로 보호된 Azure에서 확장성 있는 엔터프라이즈급 Jenkins 서버를 배포하고 작동하는 방법을 보여주는 권장된 아키텍처입니다.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>IoT 디바이스 및 데이터 분석을 사용하여 건축 프로젝트의 포괄적인 관리 및 작업을 제공합니다.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>여러 원본의 데이터를 통합하고 데이터 분석을 최적화합니다.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>기존 온-프레미스 SSIS와 Azure Data Factory를 사용한 하이브리드 ETL</h3>
                        <p>기존 온-프레미스 SSIS(SQL Server Integration Services) 배포와 Azure Data Factory를 사용한 하이브리드 ETL</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>IoT를 사용하여 실시간 차량 데이터를 수집하고 처리합니다.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure에서 디지털 이미지 기반 모델링 가속화</h3>
                        <p>Avere 및 Agisoft PhotoScan을 사용하여 Azure에서 디지털 이미지 기반 모델링 가속화</p>
                    </div>
                </div>
            </div>
        </div>
